// Can of Words — Puzzle Data v5.8
// To update puzzles: edit this file, rename to puzzles-v5.9.js (or next version),
...
const PUZZLES = [
  ...
  { clue: 'Oxygen',  sentence: 'ZWxlbWVudCBlc3NlbnRpYWwgZm9yIGh1bWFuIHJlc3BpcmF0aW9u',  type: 'regular' }, // Wed May 20
  { clue: 'The Simpsons',  sentence: 'bG9uZ2VzdCBydW5uaW5nIGFuaW1hdGVkIHNob3cgc2V0IGluIHNwcmluZ2ZpZWxk',  type: 'regular' }, // Thu May 21
  ...
  { clue: 'James Bond',  sentence: 'c3B5IHdobyBwcmVmZXJzIGhpcyBtYXJ0aW5pIHNoYWtlbiBub3Qgc3RpcnJlZA==',  type: 'regular' }, // Tue May 26
  ...
  { clue: 'Mount Everest',  sentence: 'dGFsbGVzdCBtb3VudGFpbiBwZWFrIG9uIHBsYW5ldCBlYXJ0aA==',  type: 'regular' }, // Tue Jun 2
  { clue: 'Umbrella',  sentence: 'Zm9sZGluZyBjYW5vcHkgY2FycmllZCB0byBzdGF5IGRyeSBpbiB0aGUgcmFpbg==',  type: 'regular' }, // Wed Jun 3
  { clue: 'Titanic',  sentence: 'bmluZXRpZXMgYmVzdCBwaWN0dXJlIG9zY2FyIHdpbm5lcg==',  type: 'regular' }, // Thu Jun 4
  ...
  { clue: 'Wednesday;',  sentence: 'd2lkZWx5IGtub3duIGFzIGh1bXAgZGF5IGRhdWdodGVyIGluIHRoZSBhZGRhbXMgZmFtaWx5',  type: 'sunday' }, // Sun Jun 7
  ...
  // ── WEEK 7 (Jun 15) ────────────────────────────────
  { clue: 'Escalator',  sentence: 'bW92aW5nIHN0YWlyY2FzZSBmb3VuZCBpbiBtYWxscyBhbmQgYWlycG9ydHM=',  type: 'regular' }, // Mon Jun 15
  { clue: 'Spaghetti',  sentence: 'bG9uZyBwYXN0YSB0cmFkaXRpb25hbGx5IHNlcnZlZCB3aXRoIG1lYXRiYWxscw==',  type: 'regular' }, // Tue Jun 16
  { clue: 'Flamingo',  sentence: 'dGFsbCBwaW5rIGJpcmQga25vd24gZm9yIHN0YW5kaW5nIG9uIG9uZSBsZWc=',  type: 'regular' }, // Wed Jun 17
  { clue: 'Hourglass',  sentence: 'ZGV2aWNlIHRoYXQgbWVhc3VyZXMgdGltZSB1c2luZyBmYWxsaW5nIHNhbmQ=',  type: 'regular' }, // Thu Jun 18
  { clue: 'Chess!',  sentence: 'cGF3biByb29rIGtuaWdodCBiaXNob3AgcXVlZW4ga2luZw==',  type: 'playful' }, // Fri Jun 19
  { clue: 'Socks?',  sentence: 'bGF1bmRyeSBpdGVtIG1vc3QgbGlrZWx5IHRvIGRpc2FwcGVhcg==',  type: 'playful' }, // Sat Jun 20
  { clue: 'Guinness;',  sentence: 'ZmFtb3VzIGlyaXNoIHN0b3V0IGFubnVhbCBib29rIG9mIHdvcmxkIHJlY29yZHM=',  type: 'sunday' }, // Sun Jun 21

  // ── WEEK 8 (Jun 22) ────────────────────────────────
  { clue: 'Dictionary',  sentence: 'YWxwaGFiZXRpY2FsIHJlZmVyZW5jZSBib29rIG9mIHdvcmQgZGVmaW5pdGlvbnM=',  type: 'regular' }, // Mon Jun 22
  { clue: 'Calendar',  sentence: 'dG9vbCB1c2VkIHRvIG9yZ2FuaXplIGRheXMgbW9udGhzIGFuZCB5ZWFycw==',  type: 'regular' }, // Tue Jun 23
  { clue: 'Boomerang',  sentence: 'Y3VydmVkIHRocm93aW5nIHRvb2wgdGhhdCByZXR1cm5zIHRvIGl0cyB0aHJvd2Vy',  type: 'regular' }, // Wed Jun 24
  { clue: 'Chameleon',  sentence: 'cmVwdGlsZSBmYW1vdXMgZm9yIGNoYW5naW5nIHRoZSBjb2xvciBvZiBpdHMgc2tpbg==',  type: 'regular' }, // Thu Jun 25
  { clue: 'Snooze!',  sentence: 'bmluZSBtb3JlIG1pbnV0ZXMgb2Ygc2xlZXAgcGxlYXNl',  type: 'playful' }, // Fri Jun 26
